...
public class SqlOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String MESSAGES_COLUMN_ISIMAGE = "isimage";
    public static final String MESSAGES_COLUMN_IMAGEDATA = "imagedata";
    ...
    private void createStructure(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_NAME_MESSAGES + "(" +
                ...
                MESSAGES_COLUMN_IMAGEDATA + " blob default null" +
                ");");
